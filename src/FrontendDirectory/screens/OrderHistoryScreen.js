import { View, ScrollView, Text, RefreshControl, StyleSheet, Image, Platform, TouchableOpacity } from "react-native";
...
function OrderHistoryScreen ({navigation}) {
    ...
    return (
        <View style={styles.container}>
            <HeadTitleWithBackIcon previousScreen={() => navigation.goBack()} title={"Order History"} />
            <ScrollView 
            ...
            { true ? (
                ...
                <View style={{
                    ...
                    <Image style={{width: 300, height: 300}} source={require("../../../assets/shopping.png")} />
                    <Text style={{
                        marginTop: 20,
                        fontSize: 18,
                    }}>You've ordered nothing yet!</Text>
